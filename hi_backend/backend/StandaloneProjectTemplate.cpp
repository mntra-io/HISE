...
"                       isDebug=\"0\" optimisation=\"3\" targetName=\"%NAME%\" headerPath=\"%IPP_HEADER%;/usr/local/include\"\r\n"
"                       libraryPath=\"%IPP_HEADER%;/usr/local/lib\" cppLibType=\"libc++\" linkTimeOptimisation=\"1\"\r\n"
