...
<JUCERPROJECT id="Tw64Zd" name="%NAME%" projectType="guiapp" version="%VERSION%"
  ...
  <JUCEOPTIONS JUCE_QUICKTIME="disabled" USE_BACKEND="disabled" USE_FRONTEND="enabled" USE_RAW_FRONTEND="%USE_RAW_FRONTEND%"
			   ...
			   JUCE_DSP_USE_INTEL_MKL="disabled" JUCE_WEB_BROWSER="disabled" JUCE_USE_CURL="enabled" JUCE_DSP_USE_SHARED_FFTW="disabled" JUCE_DSP_USE_STATIC_FFTW="disabled" HISE_USE_CUSTOM_EXPANSION_TYPE="%USE_CUSTOM_EXPANSION_TYPE%" HISE_INCLUDE_LORIS="%HISE_INCLUDE_LORIS%"/>
</JUCERPROJECT>)";
