...
"                       binaryPath=\"Compiled/\" headerPath=\"%ASIO_SDK_PATH%%FAUST_HEADER_PATH%; C:/Program Files/Common Files/fftw3\" linkTimeOptimisation=\"%LINK_TIME_OPTIMISATION%\" useRuntimeLibDLL=\"0\" prebuildCommand=\"%PREBUILD_COMMAND%\"/>\r\n"
"      </CONFIGURATIONS>\r\n"
"      <MODULEPATHS>\r\n"
...
"               extraDefs=\"%EXTRA_DEFINES_OSX%\" hardenedRuntime=\"1\" hardenedRuntimeOptions=\"com.apple.security.cs.allow-jit,com.apple.security.cs.allow-unsigned-executable-memory,com.apple.security.device.audio-input\" xcodeValidArchs=\"arm64,arm64e,x86_64\" iosDevelopmentTeamID=\"%DEVELOPMENT_TEAM_ID%\">\r\n"
"      <CONFIGURATIONS>\r\n"
...
"                       headerPath=\"%IPP_HEADER%;/usr/local/include\" libraryPath=\"%IPP_HEADER%;/usr/local/lib\"\r\n"
...
"                       isDebug=\"0\" optimisation=\"3\" targetName=\"%NAME%\" headerPath=\"%IPP_HEADER%%FAUST_HEADER_PATH%;/usr/local/include\"\r\n"
"                       libraryPath=\"%IPP_HEADER%%FAUST_HEADER_PATH%;/usr/local/lib\" cppLibType=\"libc++\" linkTimeOptimisation=\"%LINK_TIME_OPTIMISATION%\"\r\n"
...
"				JUCE_DSP_USE_INTEL_MKL=\"disabled\" JUCE_WEB_BROWSER=\"disabled\" JUCE_USE_CURL=\"enabled\" JUCE_DSP_USE_SHARED_FFTW=\"enabled\" JUCE_DSP_USE_STATIC_FFTW=\"disabled\" HISE_USE_CUSTOM_EXPANSION_TYPE=\"%USE_CUSTOM_EXPANSION_TYPE%\" />\r\n"
"</JUCERPROJECT>\r\n";
